    ...
    <div class="pages w-full font-sans">
        ...
        <div
            ...
            <div class="info w-full ">
                <h1 class="font-bold text-lg lg:text-2xl lg:mb-5">Ahlan wa sahlan <span class="font-normal">di situs
                        resmi</span></h1>
                ...
                <h1 class="lg:mt-8 mt-2 text-lg font-light w-11/12">Halo calon jamaah umroh kami adalah mitra terpercaya untuk
                    perjalanan
                ...
                <div class="button font-medium text-white mt-5 flex">
                    <button class="bg-yellow-500 capitalize text-lg px-6 pt-2 pb-3 mr-4 rounded-full">
        ...
        <div class="about-us capitalize text-lg py-10 px-4 lg:p-20 bg-blue-800 w-full">
            ...
            <div class="detail grid grid-cols-1 lg:grid-cols-2 gap-0 lg:gap-6 text-white">
                <h1 class="lg:text-4xl text-2xl max-lg:w-3/4 font-semibold mb-4 mt-4 w-full lg:w-8/12">Siapa sih Sinai Umroh Indarung
                    Padang itu?
                </h1>
                <h1 class="lg:text-xl text-md text-justify">Sinai Umrah adalah penyedia resmi visa Umrah, fokus pada pelayanan
            ...
            <div class="items grid grid-cols-1 lg:grid-cols-3 justify-center gap-4 lg:gap-8 mt-10">
                <div
                    ...
                    <h1 class="mt-2 text-lg lg:text-xl font-bold">Travel dengan
                        ber-izin resmi</h1>
                    <h1 class="mt-2 text-[1rem] text-xl">Sinai & Amanah Travel, resmi di bawah Kemenag RI (PPIU No. 292/2020), menjamin
                        keberangkatan setiap jamaah.</h1>
                </div>
                <div
                    class="flex flex-col items-start lg:items-center bg-white p-8 lg:rounded-lg lg:text-center rounded-xl">
                    <img src="{{ asset('aset/person.svg') }}" alt="tower" class="">
                    <h1 class="mt-2 text-lg lg:text-xl font-bold">Member Resmi IATA,
                        ASITA & Kesthuri</h1>
                    <h1 class="mt-2 text-[1rem] text-xl">Sinai & Amanah Travel adalah anggota resmi IATA, ASITA, dan KESTHURI, menjamin
                        layanan umrah dan haji yang berkualitas.</h1>
                </div>
                <div
                    class="flex flex-col items-start lg:items-center bg-white p-8 lg:rounded-lg lg:text-center rounded-xl">
                    <img src="{{ asset('aset/personpc.svg') }}" alt="tower" class="">
                    <h1 class="mt-2 text-lg lg:text-xl font-bold">Terakreditasi secara
                        Nasional</h1>
                    <h1 class="mt-2 text-[1rem] text-xl">Komite Akreditasi Nasional (KAN) adalah lembaga non-struktural yang bertanggung
                        jawab
            ...
            <div class="items grid grid-cols-1 lg:grid-cols-2 justify-center gap-4 lg:gap-8 lg:mt-5 mt-4 px-0 lg:px-60">
                <div
                    ...
                    <h1 class="mt-2 text-lg lg:text-xl font-bold">Legalitas Operasional
                        Kantor Cabang</h1>
                    <h1 class="mt-2 text-[1rem] text-xl">Setiap kantor cabang dilengkapi SK resmi dari kantor pusat, izin Kemenag setempat,
                        dan legalitas dari IATA, ASITA, & AMPHURI.</h1>
                </div>
                <div
                    class="flex flex-col items-start lg:items-center bg-white p-8 lg:rounded-lg lg:text-center rounded-xl">
                    <img src="{{ asset('aset/protect.svg') }}" alt="tower" class="">
                    <h1 class="mt-2 text-lg lg:text-xl font-bold">Sistem umroh yang
                        aman & terpercaya</h1>
                    <h1 class="mt-2 text-[1rem] text-xl">Fokus dalam penyediaan resmi visa umrah & pada pelayanan, kualitas, dan kenyamanan
        ...
        <div class="dokumentation px-10 lg:px-20 my-20 py-2 lg:py-0 w-full text-center">
            ...
            <h1 class="text-lg lg:text-4xl font-semibold mt-2">Setiap foto <span
                    class="text-yellow-600">bercerita</span>,
                setiap senyuman penuh <span class="text-blue-800">syukur</span>.</h1>
            <h1 class="text-lg lg:text-4xl font-semibold mt-2 mb-6 lg:mb-12 max-lg:w-full">Yuk, jelajahi galeri kami!📸
            </h1>
            ...
            <div class="flex flex-col">
                ...
                <div class="w-fit text-white">
                    <h1 class="text-sm lg:text-xl text-medium text-yellow-600 bg-yellow-50 w-fit px-4 py-2 rounded-full">
                        ...
                        umroh tapi
                        terbentur biaya?</h1>
                    <h1 class="text-xl lg:text-3xl font-semibold mt-4">
                        Wujudkan impian tersebut bersama kami dalam nabung umrah
                    </h1>
        ...
        {{-- packet --}}
        <div class="packets mt-28 mx-6 lg:mx-60 text-center">
            <h1 class="text-lg lg:text-xl text-medium text-blue-800 semi-bodl">Paket perjalanan ibadah</h1>
            <h1 class="lg:text-4xl text-2xl font-semibold mt-2">Yuk, umroh bareng sinai Umrah Pilihlah paket yang nyaman, biar ibadah
                main berkesan 🕋✨</h1>
        </div>
        <div class="packet grid grid-cols-1 lg:grid-cols-3 mt-6 px-2 lg:px-96 gap-8">
            <div
                ...
                <div class="grid lg:grid-cols-1  gap-4">
                    <div class="">
                        <h1 class="lg:text-2xl text-xl mb-2 text-semibold">Product sinai agustus</h1>
                        <h1 class="font-bold text-lg">Rp <span class="capitalize font-bold lg:text-3xl text-2xl">35,5
                                juta</span>
                        </h1>
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 justify-between">
                <div class="text-white">
                    <h1
                        ...
                        Testimoni</h1>
                    <h1 class="text-xl lg:text-4xl font-semibold mt-4">Gimana perasaan mereka</h1>
                    <h1 class="text-xl lg:text-4xl font-semibold mt-2 lg:mb-6">dengan sinai Umroh?</h1>
                </div>
                        ...
                        <div class="testimoni-detail flex max-md:flex-col gap-2 lg:gap-6 lg:mb-20">
                            ...
                            <div class="values bg-white rounded-xl px-4 lg:px-10 lg:mt-5 lg:mb-0">
                                <div class="value flex pt-5 pb-2 gap-2 items-center">
                                    ...
                                    <div class="">
                                        <h1 class="capitalize text-md lg:text-lg font-semibold">{{$item->nama}}</h1>
                                        <h1 class="capitalize lg:text-lg text-sm font-light">{{$item->desk}}</h1>
                                    </div>
                                </div>
                                <div class="value pb-5 lg:pb-20 gap-2">
                                    <h1 class="lg:text-xl text-md">{{$item->kesan}}</h1>
                                </div>
                            </div>
                            @endforeach
                        </div>
        ...
        <div class="w-full flex items-center justify-center text-center mt-20">
            <div class="ending-information p-0 lg:p-8 lg:w-fit rounded-xl">
                <div class="flex mx-4 flex-col items-center ">
                    ...
                    <h1 class="text-xl font-semibold mt-4 w-3/6 max-lg:w-full">Dapatkan informasi terkait
                ...
                <div class="bg-green-500 w-44 mx-auto mt-6 text-white rounded-xl px-2 py-3">
                    <a href="https://api.whatsapp.com/send/?phone=6281363209449&text&type=phone_number&app_absent=0" target="_blank" rel="noopener noreferrer">
