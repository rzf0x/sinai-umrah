        ...
        <div class="contact lg:mx-20">
            ...
            <form action="{{ route('contact-tambah') }}" method="POST"
                ...
                <div class="form flex flex-col gap-6 m-6 w-full lg:w-6/12 lg:mr-10">
                    <h1 class="text-2xl lg:mb-5 font-semibold">Hubungi Kami.</h1>
                    <input type="text" name="email" class="lg:text-2xl text-lg rounded-lg lg:py-4 w-full" placeholder="Email">
                    <input type="text" name="name" class="lg:text-2xl text-lg rounded-lg lg:py-4 w-full" placeholder="Nama">
                    <input type="text" name="subject" class="lg:text-2xl text-lg rounded-lg lg:py-4 w-full pb-10 lg:pb-20"
                        placeholder="Subjek">
                    <button type="submit"
