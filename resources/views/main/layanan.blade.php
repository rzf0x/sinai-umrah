        ...
        <div class="layanan-header flex flex-col w-full justify-center items-center max-lg:mt-44">
            <div class="flex flex-col justify-center w-full gap-2 lg:m-20 lg:mx-4 max-lg:px-2 text-center items-center">
                ...
                <div class="packet grid grid-cols-1 lg:grid-cols-3 mt-6 px-2 lg:px-96 gap-8">
                    <div
                        class="packet-1 group rounded-3xl bg-yellow-50 text-left p-8 gap-4 hover:text-white hover:bg-yellow-400 duration-200">
                        <div class="grid lg:grid-cols-1 px-10 lg:px-0 gap-4">
                            <div class="">
                ...
                <div class="syarat capitalize text-lg py-10 px-4 lg:p-20 bg-blue-800 w-full lg:mt-20">
                    <div class="syarat-header flex flex-col text-white">
                        ...
                        <h1 class="text-2xl lg:text-5xl font-semibold my-4 w-full text-start lg:w-7/12">Berikut
                ...
                <div id="form-container" class="flex flex-col justify-center w-full gap-2 items-center mt-20">
                    <h1 class="lg:text-xl text-xl text-blue-800 w-fit py-2 px-4 -mb-4 lg:-mt-0 rounded-3xl">Formulir Pendaftaran.
                    </h1>
                    <h1 class="text-2xl px-5 lg:px-0 lg:text-[3.5rem] font-semibold lg:w-6/12">Raih Kesempatan Berangkat Umrah dengan
                        Mudah! 📋
                    </h1>
                    <h1 class="text-lg lg:text-3xl font-light lg:mt-4 lg:w-8/12">Isi form pendaftaran di bawah ini dan
                ...
                <div
                    ...
                    <form action="{{ route('layanan-tambah') }}" method="POST"
                        ...
                        <div class="col-span-2">
                            <button type="submit"
                                class="capitalize text-xl px-4 mt-2 text-white bg-yellow-600 shadow-lg rounded-lg py-4 w-full">
                                Daftar
                            </button>
                        </div>
                    </form>
